...
Every service from the brief (§2), plus the ones on MG's booking page. **Real prices** come from MG's booking page, service pages and shop (checked 25 September 2026). Lines marked *(placeholder)* have no published MG price and use the obvious "From €X" pattern: MG must fill them in, or delete the price and keep the "Ask for a quote" link.

Two prices come from MG's individual service pages, while the build spec lists them as "price on request": Mercedes and VW Japan-to-Europe conversions and radio frequency conversion. **Confirm these with MG.**
...
OEM-style widescreen Android displays with CarPlay and Android Auto built in. From €X fitted *(placeholder)*.
...
Replace a tired factory radio with a modern head unit with Bluetooth, USB and CarPlay. From €X fitted *(placeholder)*.
[Get a quote](/pages/get-a-quote)

### JBL radios

Head units from JBL, one of the brands we trust. From €X fitted *(placeholder)*.
[Get a quote](/pages/get-a-quote)
...
Clearer vocals and tighter bass from quality door speakers, fitted properly. From €X fitted *(placeholder)*.
[Shop speakers](/collections/speakers)

### Subwoofers

Deep, controlled bass without losing your boot. From €X fitted *(placeholder)*.
[Shop subwoofers](/collections/subwoofers)

### Amplifiers

More power and less distortion for your speakers and sub. From €X fitted *(placeholder)*.
[Shop amplifiers](/collections/amplifiers)
...
Front or front-and-rear dashcams, hard-wired with no trailing cables. From €X fitted *(placeholder)*.
[Shop dashcams](/collections/dashcams)

## Japanese imports

### Japan-to-Europe conversions

European maps, English menus and the European radio band for imported cars. BMW **€450** (about 2 hours), Mercedes-Benz **€450**, Volkswagen MIB 2012–2018 **€350** *(confirm Mercedes and VW)*.
...
Get every Irish station on an imported Japanese radio. **€150** *(confirm)*, about 1 hour.
...
Speakers gone quiet? We trace the fault, from fuses and wiring to amplifiers, and fix it. Diagnosis from €X *(placeholder)*.
[Get a quote](/pages/get-a-quote)

### Black-screen repair

Screen stays black or keeps restarting? We diagnose and repair head units and screens. Diagnosis from €X *(placeholder)*.
[Get a quote](/pages/get-a-quote)

### Radio password and code

Radio asking for a code after a battery change? We'll get it working again. From €X *(placeholder)*.
[Get a quote](/pages/get-a-quote)
